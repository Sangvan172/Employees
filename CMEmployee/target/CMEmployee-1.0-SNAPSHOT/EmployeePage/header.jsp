                    ...
                    <nav>
                        <ul id="main-menu">
                            <li style="margin-left: 10px;">
                                <c:choose>
                                    <c:when test="${sessionScope.phone != null}">
                                        <a href="/employee/orderList" class="menu-link">Order List</a>
                                    </c:when>
                                    <c:otherwise>
                                        <a href="/employee/login" class="menu-link">Order List</a>
                                    </c:otherwise>
                                </c:choose>
                            </li>
                            <li style="margin-left: 10px;">
                                <a href="/employee/delivery" class="menu-link">Delivery</a>
                            </li>
                            <li style="margin-left: 10px;">
                                <a href="/employee/newOrderList" class="menu-link">New Order</a>
                            </li>
                            <%
                            ...
                            <li style="margin-right: 40px;">
                                ...
                                <ul class="sub-menu">
                                    <li><a style="color: black" href="/employee/login">Login</a></li>
                                </ul>
                            </li>
                            <% } else { %>
                            <li style="margin-left: 50px;">>
                                ...
                                <ul class="sub-menu">
                                    <li><a style="color: black" href="/employee/updateProfile">Profile</a></li>
                                    <li><a style="color: black" href="/employee/changePassword">Change Password</a></li>
                                    <li><a style="color: black" href="/employee/logout">Logout <ion-icon style="display: inline-block; vertical-align: middle; margin-left: 2px; font-size: 24px;" name="log-out-outline"></ion-icon></a></li>
                                </ul>
                            </li>
                            <% }%>
                        </ul>
