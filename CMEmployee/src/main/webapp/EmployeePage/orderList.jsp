    ...
    <head>
        ...
        <style>
            ...
            .search-container {
                ...
                align-items: center;
                margin-bottom: 20px;
                margin-right: 20px; /* Thêm margin để tạo khoảng cách giữa nút tìm kiếm và logo */
            }
                ...
                <div class="search-container">
                    ...
                    <div id="dateInputs" style="display: none;">
                        <form id="dateSearchForm" action="/employee" method="post">
                            ...
                            <button type="submit" class="mx-2" style="border: none; background: none" name="btnSearch" value="Search">
                                <i class="fa-solid fa-magnifying-glass nav_acc_glass" style="color: white; background-color: blue;"></i>
                            </button>
                        </form>
                    </div>
                    <input type="text" id="searchInput" placeholder="Search by Order ID" class="form-control mx-2">
                    <button style="background-color:white; color: black" type="button" class="btn btn-custom searchButton">Search</button>
                </div>
            </div>
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody id="itemList">
                            ...
                            <tr>
                                ...
                                <td><a class="btn btn-outline-primary btnView" href="/orderDetail/<%= rs.getString("ord_id")%>" style="color: black;">View</a></td>
                            </tr>   
                            <%
                                }
                            %>
